...
export default function Footer({ position }: { position: FooterPosition }) {
    ...
    return (
        <footer className={`footer navbar-light bg-light pt-1 pb-2 ${clz()}`}>
                    ...
                    <div className="col-12 col-lg-6 pe-lg-4 order-lg-2">
                        <ul className="nav nav-footer justify-content-center justify-content-lg-end">
                            <li className="nav-item">
                                <Link href={"/"} target="_self" className={`nav-link text-muted px-1`}>Home</Link>
                            </li>
                            <li className="nav-item">
                                <Link href={"/tnc/terms"} target="_self" className={`nav-link text-muted px-2`}>Terms</Link>
                            </li>
                            <li className="nav-item">
                                <Link href={"/tnc/privacy"} target="_self" className={`nav-link text-muted px-1`}>Privacy</Link>
                            </li>
                        </ul>
                    </div>
